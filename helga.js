...
Base : Denis
Kalo Mau Recode/Reupload Kasih Credit!

- Jangan Hapus Createor!!
- Ketawan?Di Entod Satu Negara Lu!!
- Script HELGAV17 FIX ALL!
- Tiktok Download Tambahin Sendiri!!
- Apikey?Free Cuman Gw Gada Rest Apii!!

NOTE : Jangan Di Hapus Kontol!!
*/
const
	{
...
const ownerNumber = "6282138919347@s.whatsapp.net"
...
_🌨️${prefix}ownermenu_

_🌨️${prefix}groupmenu_

_🌨️${prefix}funmenu_

_🌨️${prefix}downloadmenu_

_🌨️${prefix}makermenu_

_🌨️${prefix}toolsmenu_

_🌨️${prefix}othermenu_

Note : Jika Buton Tidak Muncul Ketik .allmenu`
sendButLocation(from, `${menu}`, "AyaaChan", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`allmenu`,buttonText:{displayText:'𝘼𝙇𝙇 𝙈𝙀𝙉𝙐🌦️'},type:1},{buttonId:`store`,buttonText:{displayText:'𝙎𝙀𝙒𝘼 𝘽𝙊𝙏💤'},type:1},{buttonId:`tos`,buttonText:{displayText:'𝙍𝙐𝙇𝙀𝙎🌨'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
{buttonId:`rules`,buttonText:{displayText:'𝙍𝙐𝙇𝙀𝙎🌨️'},type:1},
]
...
case 'allmenu':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
       ...
       stst = await helga.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
       menu = `🌳豈 _Creator : @${dtod.split('@')[0]}_
...
*🍃ヅ* ${prefix}cecanmalaysia
*🍃ヅ* ${prefix}cecankorea
*🍃ヅ* ${prefix}cecanindonesia
*🍃ヅ* ${prefix}cecanjapan
*🍃ヅ* ${prefix}cecanthailand
*🍃ヅ* ${prefix}bokep
...
*🐢 › SC NO PASARAN › 🐢*`
sendButLocation(from, `${menu}`, "_AyaaaChan🌸_", {jpegThumbnail:logonya,name:""}, [{buttonId:`menu`,buttonText:{displayText:'𝙈𝙀𝙉𝙐🍁'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan AyaaBott-
😖🙏`
sendButLocation(from, `${menu}`, "©AyaaChan", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'SIAP OM'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'verify':
